...
class AuthProvider extends ChangeNotifier {
  ...
  bool get isFullyEnrolled =>
      _currentUser != null && _currentUser!.hasCompletedOnboarding;

  bool get hasAcceptedConsent => _currentUser?.consentAccepted ?? false;

  bool get hasCompletedTutorial => _currentUser?.tutorialCompleted ?? false;
